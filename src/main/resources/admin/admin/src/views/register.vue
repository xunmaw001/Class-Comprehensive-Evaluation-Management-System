  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="班主任工号" class="input" v-if="tableName=='xuesheng'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.xingbie) && `xuesheng` == this.tableName){
      ...
      if((!this.ruleForm.banzhurengonghao) && `xuesheng` == this.tableName){
        this.$message.error(`班主任工号不能为空`);
        return
      }
      if((!this.ruleForm.banzhurengonghao) && `banzhuren` == this.tableName){
        this.$message.error(`班主任工号不能为空`);
        return
      }
      ...
      if((!this.ruleForm.banzhurenxingming) && `banzhuren` == this.tableName){
