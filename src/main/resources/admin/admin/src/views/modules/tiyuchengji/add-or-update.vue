<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="学年" prop="xuenian">
          <el-select :disabled="ro.xuenian" v-model="ruleForm.xuenian" placeholder="请选择学年">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体育分" prop="tiyufen">
          <el-input v-model="ruleForm.tiyufen" 
              placeholder="体育分" clearable  :readonly="ro.tiyufen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体育分" prop="tiyufen">
              <el-input v-model="ruleForm.tiyufen" 
                placeholder="体育分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体育成绩" prop="tiyuchengji">
            <el-input v-model="tiyuchengji"
                placeholder="体育成绩" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tiyuchengji" label="体育成绩" prop="tiyuchengji">
...
export default {
  data() {
	...
	tiyuchengji : false,
      ...
      rules: {
          ...
          tiyufen: [
                { required: true, message: '体育分不能为空', trigger: 'blur' },
  ...
  computed: {
    ...
    tiyuchengji:{
      get: function () {
        return 1*this.ruleForm.tiyufen*this.ruleForm.bili
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuenian = true;
          ...
          if(o=='tiyufen'){
            this.ruleForm.tiyufen = obj[o];
	    this.ro.tiyufen = true;
            continue;
          }
          if(o=='bili'){
    ...
    // 提交
    onSubmit() {
        this.ruleForm.tiyuchengji = this.tiyuchengji
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tiyuchengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tiyuchengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
