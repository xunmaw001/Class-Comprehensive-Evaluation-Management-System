      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="智育成绩" prop="zhiyuchengji">
          <el-input v-model="ruleForm.zhiyuchengji" 
              placeholder="智育成绩" clearable  :readonly="ro.zhiyuchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="智育成绩" prop="zhiyuchengji">
              <el-input v-model="ruleForm.zhiyuchengji" 
...
export default {
  data() {
	...
	lurushijian : false,
      ...
      rules: {
          ...
          tiyuchengji: [
                { required: true, message: '体育成绩不能为空', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          deyuchengji: [
                { required: true, message: '德育成绩不能为空', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          zhiyuchengji: [
                { required: true, message: '智育成绩不能为空', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          zonghechengji: [
                { validator: validateNumber, trigger: 'blur' },
  ...
  computed: {
    zonghechengji: {
      get: function () {
        return 0+parseFloat(this.ruleForm.tiyuchengji==""?0:this.ruleForm.tiyuchengji)+parseFloat(this.ruleForm.deyuchengji==""?0:this.ruleForm.deyuchengji)+parseFloat(this.ruleForm.zhiyuchengji==""?0:this.ruleForm.zhiyuchengji) || 0
      }
    },
