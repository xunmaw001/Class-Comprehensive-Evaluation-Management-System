<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班主任电话" prop="banzhurendianhua">
          <el-input v-model="ruleForm.banzhurendianhua" 
              placeholder="班主任电话" clearable  :readonly="ro.banzhurendianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班主任电话" prop="banzhurendianhua">
              <el-input v-model="ruleForm.banzhurendianhua" 
                placeholder="班主任电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `banzhuren/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.banzhurenCrossAddOrUpdateFlag = false;
						 this.parent.search();
