<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="基础成绩" prop="jichuchengji">
          <el-input v-model="ruleForm.jichuchengji" 
              placeholder="基础成绩" clearable  :readonly="ro.jichuchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="基础成绩" prop="jichuchengji">
              <el-input v-model="ruleForm.jichuchengji" 
                placeholder="基础成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加分" prop="jiafen">
          <el-input v-model="ruleForm.jiafen" 
              placeholder="加分" clearable  :readonly="ro.jiafen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加分" prop="jiafen">
              <el-input v-model="ruleForm.jiafen" 
                placeholder="加分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="扣分" prop="koufen">
          <el-input v-model="ruleForm.koufen" 
              placeholder="扣分" clearable  :readonly="ro.koufen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="扣分" prop="koufen">
              <el-input v-model="ruleForm.koufen" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="德育成绩" prop="deyuchengji">
            <el-input v-model="deyuchengji"
                placeholder="德育成绩" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.deyuchengji" label="德育成绩" prop="deyuchengji">
...
export default {
  ...
  computed: {
    ...
    deyuchengji:{
      get: function () {
        return (0+parseFloat(this.ruleForm.jichuchengji==""?0:this.ruleForm.jichuchengji)+parseFloat(this.ruleForm.jiafen==""?0:this.ruleForm.jiafen)+parseFloat(this.ruleForm.koufen==""?0:this.ruleForm.koufen)) * 1*this.ruleForm.bili
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tiyuchengji = true;
          ...
          if(o=='jichuchengji'){
            this.ruleForm.jichuchengji = obj[o];
	    this.ro.jichuchengji = true;
            continue;
          }
          if(o=='jiafen'){
            this.ruleForm.jiafen = obj[o];
	    this.ro.jiafen = true;
            continue;
          }
          if(o=='koufen'){
    ...
    // 提交
    onSubmit() {
        this.ruleForm.deyuchengji = this.deyuchengji
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `deyuchengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.deyuchengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
